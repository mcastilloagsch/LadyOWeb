...
<div class="container">
  ...
  function APIGET($ruta){
    $url = "http://localhost:100/api/Branches/getObject/{token}/";
    $respuesta = $url . $ruta;
    return $respuesta;
  }
  ...
  $unit_namenew = $datos["data"]["unit_name"];
  $small_teamnew = $datos["data"]["small_team"];


  echo "
  <form action='edit_branche.php' method='post'>
  ...
  <input type='text' name='unit_name' value='$unit_namenew'>
  <br>
  <label for=''>Pequeño equipo</label>
  <input type='text' name='small_team' value='$small_teamnew'>
  <br>
